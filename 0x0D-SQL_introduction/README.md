# MySQL - Introduction
Project done during **ALX Full Stack Software Engineering studies**. It aims to learn about databases, relational databases, subqueries, tables, **MySQL** statements and functions.
